...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../../../Users/Simis/.designer/backup/laheta.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../../../Users/Simis/.designer/backup/peru.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.laloitusnro_lineEdit.setGeometry(QtCore.QRect(210, 320, 281, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        Form.setTabOrder(self.laloitusnro_lineEdit, self.llaheta_pushButton)
    ...
    def retranslateUi(self, Form):
        ...
        self.lsalattu_tdsto_lineEdit.setPlaceholderText(_translate("Form", "testMessage.txt"))
        ...
        self.lsijoitusavain_tdsto_lineEdit.setPlaceholderText(_translate("Form", "indexFile.txt"))
