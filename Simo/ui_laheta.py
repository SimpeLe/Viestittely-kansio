...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.llaheta_pushButton.setToolTip(_translate("MainWindow", "lähetä viesti, ALT+L"))
        self.llaheta_pushButton.setText(_translate("MainWindow", "Lähetä"))
        self.llaheta_pushButton.setShortcut(_translate("MainWindow", "Alt+L"))
        self.lperu_pushButton.setToolTip(_translate("MainWindow", "peru ja siirry takaisin kotisivulle, ALT+P"))
        self.lperu_pushButton.setText(_translate("MainWindow", "Peru"))
        self.lperu_pushButton.setShortcut(_translate("MainWindow", "Alt+P"))
        self.lvastaanottaja_lineEdit.setToolTip(_translate("MainWindow", "vastaanottajan IP"))
        self.lsalattu_tdsto_lineEdit.setToolTip(_translate("MainWindow", "salattu viesti-tiedosto"))
        self.lsalattu_tdsto_lineEdit.setText(_translate("MainWindow", "lopuksi salattu viesti-tiedosto"))
        self.lveistintalletuspolku_lineEdit.setToolTip(_translate("MainWindow", "viestin talletuspolku"))
        self.lveistintalletuspolku_lineEdit.setText(_translate("MainWindow", "viestin talletuspolku"))
        self.lsijoitusavainpolku_lineEdit.setToolTip(_translate("MainWindow", "sijoitusavaimen talletuspolku"))
        self.lsijoitusavainpolku_lineEdit.setText(_translate("MainWindow", "sijoitusavaimen polku"))
        self.lkirjoitusavainpolku_lineEdit.setToolTip(_translate("MainWindow", "kirjoitusavaimen talletuspolku"))
        ...
        self.laloitusnro_lineEdit.setToolTip(_translate("MainWindow", "kirjoita joku luku <5000. Ei saa olla sama kuin viime kerralla."))
        self.lkirjoitusavain_tdsto_lineEdit.setToolTip(_translate("MainWindow", "kirjoitusavain-tiedostonimi"))
        self.lkirjoitusavain_tdsto_lineEdit.setText(_translate("MainWindow", "kirjoitusavain-tiedostonimi"))
        self.lsalattu_tdsto_lineEdit_3.setToolTip(_translate("MainWindow", "sijoitusavain-tiedostonimi"))
        self.lsalattu_tdsto_lineEdit_3.setText(_translate("MainWindow", "sijoitusavain-tiedostonimi"))
        self.lviesti_textBrowser.setToolTip(_translate("MainWindow", "kirjoita viestisi tähän"))
