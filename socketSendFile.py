...
def sendFileViaIP(ip = "192.168.10.48", port = 5001, ssfkohdeKansio = "C:/Tekstit", filename = "messageFile.txt"):
    SEPARATOR = "<SEPARATOR>"
    ...
    ssfkotiKansio = os.getcwd()
    os.chdir(ssfkohdeKansio)
